...
```{r, fig.width= 10, echo=FALSE, message=F }
...
```{r, echo=F}
load(file="Parallel_results2.Rdata")
load(file="Parallel_results2_6.Rdata")
```
...
data.plot_DAT$In_sample <- factor(rep(1:n_t %in% time_grid,n_l)); levels(data.plot_DAT$In_sample) <- c("No","Yes")
...
```{r, echo=F}
load(file="Parallel_results2_prediction_1_80.R")
```
